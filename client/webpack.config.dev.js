...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      Components: appConfig.paths.appComponents,
      Containers: appConfig.paths.appContainers,
      Pages: appConfig.paths.appPages,
      Actions: appConfig.paths.appActions,
      Reducers: appConfig.paths.appReducers,
      Store: appConfig.paths.appStore,
