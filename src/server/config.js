...
const {
  ...
  STRIPE_PLAN_ID_DEVELOPMENT,
  STRIPE_PLAN_ID_PRODUCTION,
} = process.env;
...
export default {
  ...
  payMethod: {
    stripeApiKey: isDevelopment ? STRIPE_API_KEY_DEVELOPMENT : STRIPE_API_KEY_PRODUCTION,
    stripeSecretKey: isDevelopment ? STRIPE_SECRET_KEY_DEVELOPMENT : STRIPE_SECRET_KEY_PRODUCTION,
    stripePlanId: isDevelopment ? STRIPE_PLAN_ID_DEVELOPMENT : STRIPE_PLAN_ID_PRODUCTION,
  },
  auth: {
    facebook: {
