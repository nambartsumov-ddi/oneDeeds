...
const Layout = ({ isOpen, playMainVideo, isClickedPlayButton }) => {
  ...
  return (
    <div className={layoutClasses}>
      <Panel className={panelHover} size="Full" title="One is Powerful, Many are Unstoppable" imageSrc={handsFull}>
        {/* TODO: <MainVideo /> */}
        <svg width="62" height="62" viewBox="0 0 153 153" className={styles.PlayIcon} onClick={playMainVideo}>
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({ playMainVideo }, dispatch);
};
