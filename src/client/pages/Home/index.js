  ...
  render() {
    ...
    return (
      <div className={styles.Home}>
        ...
        <Layout>
          <Panel size="Full" style={this.state.styleFullPanel}>
            <Panel
              id="1"
            ...
            <Panel
              ...
              size="Half"
              title="JFCS &amp; OneDeeds"
              description="We at OneDeeds are starting a new and exciting collaborations with JFCS. Our online community will donate and help JFCS amazing projects to help combat hunger."
              className={styles.GoodsPanel}>
              <div className="Goods">
                <iframe
