    ...
    <div className={styles.About}>
      ...
      <div className={AboutContentClasses}>
        <div className={styles.AboutPageContent}>
          ...
          <p>
                Here at OneDeeds, we believe that all it takes to change the world is community. By building a community
                of people and giving every individual member the same good deed to complete every month, we’re making a
                huge overall impact.
              </p>
            ...
            <div className={styles.BottomContent}>
              <div className={styles.OurVisionContent}>
                ...
                <p>
                  Our vision is to get the do-ers and the change-makers of the world together to make things happen.
                  With a strong community and good deeds - we can change the world!
                </p>
              </div>
              <div className={styles.Team}>
                ...
                <div className={styles.TeamWrapper}>
                  ...
                  <div className={styles.Team1}>
                    ...
                    <p>
                      David holds a B.Sc. in Industrial Engineering, specializing in information systems from SCE
                      College.
                    </p>
